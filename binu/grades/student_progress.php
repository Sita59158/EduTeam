...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .search-card { background: white; border-radius: 12px; box-shadow: 0 1px 4px rgba(0,0,0,0.08); padding: 20px; margin-bottom: 24px; display: flex; align-items: center; gap: 12px; flex-wrap: wrap; }
        .search-card label { font-size: 14px; font-weight: 600; color: #444; }
        .search-card input { padding: 9px 14px; border: 1.5px solid #ddd; border-radius: 8px; font-size: 14px; width: 160px; }
        .search-card input:focus { outline: none; border-color: #4a235a; }
        .search-card button { padding: 9px 22px; background: #4a235a; color: white; border: none; border-radius: 8px; font-size: 14px; font-weight: 600; cursor: pointer; }
        .search-card button:hover { background: #6b3580; }
        ...
        .empty-state { text-align: center; padding: 60px 20px; color: #999; background: white; border-radius: 12px; box-shadow: 0 1px 4px rgba(0,0,0,0.08); }
...
<div class="navbar">
    ...
    <div class="navbar-right">
        <a href="#">Dashboard</a>
        <a href="teacher_grades.php">Grade Management</a>
...
<div class="container">
    ...
    <div id="content" class="hidden">
        <div class="stat-row">
            <div class="stat-box"><div class="s-label">Student ID</div><div class="s-value" id="c-sid">—</div></div>
            <div class="stat-box"><div class="s-label">Total Courses</div><div class="s-value" id="c-courses">—</div></div>
            <div class="stat-box pass-c"><div class="s-label">Courses Passed</div><div class="s-value" id="c-pass">—</div></div>
            <div class="stat-box impr-c"><div class="s-label">Avg Improvement</div><div class="s-value" id="c-impr">—</div></div>
        </div>
        ...
        <div class="charts-grid">
            <div class="chart-box">
                ...
                <div class="legend">
                    ...
                    <div class="legend-item"><div class="legend-dot" style="background:#4a235a"></div> Final Term</div>
                </div>
    ...
    function renderCharts(data) {
        ...
        barChart = new Chart(document.getElementById('barChart'), {
            ...
            data: { labels: courses, datasets: [
                ...
                { label: 'Final Term', data: final, backgroundColor: 'rgba(74,35,90,0.8)',   borderRadius: 6 }
            ]},
        ...
        lineChart = new Chart(document.getElementById('lineChart'), {
            ...
            data: { labels: courses, datasets: [
                ...
                { label: 'Final Term', data: final, borderColor: '#4a235a', backgroundColor: 'rgba(74,35,90,0.1)',   tension: 0.4, fill: true, pointRadius: 5, pointBackgroundColor: '#4a235a' }
            ]},
            options: { responsive: true, maintainAspectRatio: false,
